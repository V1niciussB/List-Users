...
{
    /**
     * Método estático pode ser chamado diretamente na classe, sem a necessidade 
     * de criar uma instancia (objeto) da classe.
    ...
    {
        // Elimnar a barra no final da URL
        $url = rtrim($url, "/");
        ...
        // Substituir os caracteres não aceitos pelos aceitos  
